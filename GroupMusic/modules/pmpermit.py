...
async def pmPermit(client: USER, message: Message):
    await USER.send_message(
        message.chat.id,
        "👋🏻 Halo kawan , saya adalah layanan asisten musik .\n\n ❗️ Rules:\n   - Tidak boleh mengobrol\n   - Tidak boleh spam chat \n\n 👉 **KIRIM LINK UNDANGAN GRUP ATAU NAMA PENGGUNA JIKA USERBOT TIDAK BISA BERGABUNG DENGAN GRUP ANDA.**\n\n ⚠️ Penolakan: Jika Anda mengirim pesan di sini berarti admin akan melihat pesan Anda dan bergabung dengan obrolan\n    - Owner @rifkyyyyyyyyyyyyyyyy.\n   - Group Support @viraltwittergrup\n\n**Managed with by rifky**\n**Modifided with by** @PacarFerdilla",
    )
    return
